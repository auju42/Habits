...
export default function HabitForm({ onClose, onSubmit }: HabitFormProps) {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-[100]">
            <div className="bg-white dark:bg-gray-800 rounded-2xl w-full max-w-md shadow-xl transform transition-all max-h-[90dvh] flex flex-col">
                ...
                <div className="p-4 sm:p-6 border-t border-gray-100 dark:border-gray-700 flex-shrink-0 flex justify-end gap-3 bg-white dark:bg-gray-800 rounded-b-2xl">
                    <button
                        type="button"
                        onClick={onClose}
